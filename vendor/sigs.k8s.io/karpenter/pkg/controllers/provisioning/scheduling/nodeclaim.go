...
func (n *NodeClaim) Add(pod *v1.Pod) error {
	...
	// Ignore HugePage-* resources as they are not supported by cloud providers and are managed by customers
	filtered := filterInstanceTypesByRequirements(n.InstanceTypeOptions, nodeClaimRequirements, ignoreHugePages(requests))
